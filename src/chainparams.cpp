...
public:
    CMainParams() {
        strNetworkID = "main";
        consensus.nSubsidyHalvingInterval = 525600; //Halving 1 año
        ...
        consensus.nMinerConfirmationWindow = 1440; // Ajuste de la Diff (1 dia)
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1486949366, 1173233, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xce0ba1c4faf272292f578cba96285d5b5e830c50782c7ace02befb2d619ea1d1"));
        assert(genesis.hashMerkleRoot == uint256S("0x940db241d8ce74c451c949a5e5a24d4eddb137534ff3b64e31be00b00cfe8187"));
...
public:
    CRegTestParams() {
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x195ba3b81a90cf09e9181157695bad120f683d55159c34b643963ce38d25ba45"));
        assert(genesis.hashMerkleRoot == uint256S("0x940db241d8ce74c451c949a5e5a24d4eddb137534ff3b64e31be00b00cfe8187"));
